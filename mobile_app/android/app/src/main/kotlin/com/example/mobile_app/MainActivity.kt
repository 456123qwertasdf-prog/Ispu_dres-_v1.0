...
class MainActivity : FlutterActivity() {
    ...
    private val INSTALL_CHANNEL = "com.example.mobile_app/install"
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, INSTALL_CHANNEL).setMethodCallHandler { call, result ->
            when (call.method) {
                ...
                "installApkFromPath" -> {
                    ...
                    if (path != null) {
                        installApkFromPath(path, result)
                    } else {
    ...
    private fun installApkFromPath(path: String, result: MethodChannel.Result) {
        try {
