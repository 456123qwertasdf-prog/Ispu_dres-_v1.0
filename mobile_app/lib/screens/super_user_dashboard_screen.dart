...
class _SuperUserDashboardScreenState extends State<SuperUserDashboardScreen> {
  ...
  final GlobalKey _tourNavAlerts = GlobalKey();
  final GlobalKey _tourNavAnnouncements = GlobalKey();
  ...
  // Super User web theme (match public/super-user.html and css/su-header-shared.css)
  static const Color _suPrimary = Color(0xFF2563eb);
  static const Color _suPrimaryLight = Color(0xFF3b82f6);
  static const Color _suBg = Color(0xFFf1f5f9);
  static const Color _suHeaderStart = Color(0xFF0f172a);
  static const Color _suHeaderEnd = Color(0xFF1e3a8a);
  static const Color _tourAccent = Color(0xFF2563eb);
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      Future.delayed(const Duration(milliseconds: 350), () {
        ...
        try {
          ...
          debugPrint('Super user tour error: $e\n$st');
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget build(BuildContext context) {
    return ShowCaseWidget(
      ...
      backgroundColor: _suBg,
      appBar: AppBar(
        title: Showcase(
          key: _tourWelcome,
          title: 'Welcome to Kapiyu Super User',
          description: 'Manage emergency reports, SOS alerts, and announcements for campus. This tour will show you the main features.',
        ...
        flexibleSpace: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [_suHeaderStart, _suHeaderEnd],
            ),
          ),
        ),
        actions: [
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Header Card
            Showcase(
              key: _tourDashboardHeader,
              title: 'Dashboard',
              description: 'Overview and stats. Use the tabs below to open Reports, Alerts, and Announcements.',
              tooltipBackgroundColor: _tourAccent,
              textColor: Colors.white,
              titleTextStyle: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w700),
              descTextStyle: TextStyle(color: Colors.white.withOpacity(0.95), fontSize: 14, height: 1.4),
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: _suPrimaryLight.withOpacity(0.3),
                    blurRadius: 20,
      ...
      child: Column(
        children: [
                  ...
                  child: CircleAvatar(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [
                            _suPrimaryLight.withOpacity(0.2),
                            _suPrimaryLight.withOpacity(0.1),
                          ],
                        ),
                        shape: BoxShape.circle,
                      ),
            ...
            child: Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: _tourAccent.withOpacity(0.1),
                    borderRadius: BorderRadius.circular(12),
                  ),
          ...
          _buildMenuItem(
            ...
            color: const Color(0xFFef4444),
            onTap: () {
              Navigator.pushNamed(context, '/super-user-sos-alerts');
            },
          ),
          _buildMenuItem(
          ...
          child: Row(
            ...
            children: [
              Showcase(
                ...
                title: 'Dashboard',
                description: 'Overview, stats, and readiness message. Tap Alerts for quick one-tap emergency alerts.',
                tooltipBackgroundColor: _tourAccent,
                textColor: Colors.white,
                titleTextStyle: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w700),
                descTextStyle: TextStyle(color: Colors.white.withOpacity(0.95), fontSize: 14, height: 1.4),
              ...
              Showcase(
                key: _tourNavReports,
                title: 'Reports',
                description: 'View and manage all emergency reports. To assign a responder: tap a report to open it, then tap "Assign Responder" to choose who to send. You can also assign backup responders from the same screen.',
                tooltipBackgroundColor: _tourAccent,
                textColor: Colors.white,
                titleTextStyle: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w700),
                descTextStyle: TextStyle(color: Colors.white.withOpacity(0.95), fontSize: 14, height: 1.4),
              ...
              Showcase(
                key: _tourNavAlerts,
                title: 'Alerts',
                description: 'SOS and quick alerts. Tap for urgent notifications.',
                tooltipBackgroundColor: _tourAccent,
                textColor: Colors.white,
                titleTextStyle: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w700),
                descTextStyle: TextStyle(color: Colors.white.withOpacity(0.95), fontSize: 14, height: 1.4),
              ...
              Showcase(
                key: _tourNavAnnouncements,
                title: 'Announcements',
                description: 'Create and manage announcements for citizens and responders.',
                tooltipBackgroundColor: _tourAccent,
                textColor: Colors.white,
                titleTextStyle: const TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w700),
                descTextStyle: TextStyle(color: Colors.white.withOpacity(0.95), fontSize: 14, height: 1.4),
